...
function Home() {
  return <Shell>
    ...
    <main>
      ...
      <section className="section"><div className="container-wide"><div style={{ textAlign: 'center', marginBottom: '64px' }}><div style={{ display: 'inline-block', padding: '8px 16px', border: '1px solid hsl(var(--primary))', borderRadius: '20px', fontSize: '12px', fontWeight: 600, letterSpacing: '0.08em', color: 'hsl(var(--primary))', marginBottom: '32px' }}>HOW IT WORKS</div><h2 className="section-title display" style={{ marginBottom: '24px' }}>Our Manufacturing<br />Process</h2><p style={{ fontSize: '16px', color: 'hsl(var(--muted-foreground))', maxWidth: '600px', margin: '0 auto' }}>A documented, repeatable workflow — so every panel arrives installation-ready and performs reliably from day one.</p></div><div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginTop: '48px', position: 'relative' }}><article style={{ backgroundColor: 'hsl(var(--secondary))', borderRadius: '12px', padding: '32px', position: 'relative', display: 'flex', flexDirection: 'column', gap: '16px' }}><div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', border: '2px solid hsl(var(--primary))', borderRadius: '8px', fontSize: '14px', fontWeight: 700, color: 'hsl(var(--primary))' }}>01</div><h3 style={{ fontSize: '18px', fontWeight: 600, margin: '12px 0 0 0' }}>Project Review &<br />Quotation</h3><p style={{ margin: 0, color: 'hsl(var(--muted-foreground))', fontSize: '14px' }}>We review your drawings, schematics, BOM, and technical requirements, then evaluate component availability and timelines to provide an accurate quotation.</p></article><article style={{ backgroundColor: 'hsl(var(--secondary))', borderRadius: '12px', padding: '32px', position: 'relative', display: 'flex', flexDirection: 'column', gap: '16px' }}><div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', border: '2px solid hsl(var(--primary))', borderRadius: '8px', fontSize: '14px', fontWeight: 700, color: 'hsl(var(--primary))' }}>02</div><h3 style={{ fontSize: '18px', fontWeight: 600, margin: '12px 0 0 0' }}>Procurement &<br />Planning</h3><p style={{ margin: 0, color: 'hsl(var(--muted-foreground))', fontSize: '14px' }}>Our procurement specialists source materials from trusted manufacturers while production scheduling ensures an efficient workflow and on-time delivery.</p></article><article style={{ backgroundColor: 'hsl(var(--secondary))', borderRadius: '12px', padding: '32px', position: 'relative', display: 'flex', flexDirection: 'column', gap: '16px' }}><div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', border: '2px solid hsl(var(--primary))', borderRadius: '8px', fontSize: '14px', fontWeight: 700, color: 'hsl(var(--primary))' }}>03</div><h3 style={{ fontSize: '18px', fontWeight: 600, margin: '12px 0 0 0' }}>Panel Assembly</h3><p style={{ margin: 0, color: 'hsl(var(--muted-foreground))', fontSize: '14px' }}>Skilled technicians assemble each panel to your specifications using standardized procedures — with in-process quality inspections at every stage of the build.</p></article><article style={{ backgroundColor: 'hsl(var(--secondary))', borderRadius: '12px', padding: '32px', position: 'relative', display: 'flex', flexDirection: 'column', gap: '16px' }}><div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '48px', height: '48px', border: '2px solid hsl(var(--primary))', borderRadius: '8px', fontSize: '14px', fontWeight: 700, color: 'hsl(var(--primary))' }}>04</div><h3 style={{ fontSize: '18px', fontWeight: 600, margin: '12px 0 0 0' }}>Testing & QA</h3><p style={{ margin: 0, color: 'hsl(var(--muted-foreground))', fontSize: '14px' }}>Every panel undergoes comprehensive inspection and functional testing before shipment. Factory Acceptance Testing (FAT) is available upon request.</p></article></div></div></section>
