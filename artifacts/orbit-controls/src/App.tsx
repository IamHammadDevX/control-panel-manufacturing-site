...
function About() {
  return <Shell><Seo title="About WETS AI | Manufacturing Excellence" description="Meet WETS AI, a disciplined control-panel manufacturing partner for North American OEMs and automation teams." /><main><PageIntro eyebrow="Our standard / Manufacturing excellence" title={<>Precision is a <span style={{ color: 'hsl(var(--primary))' }}>habit.</span></>} copy="We are a control-panel manufacturing partner built for teams who care about what happens after the drawing is released. Our shop brings engineering rigor and hands-on craftsmanship to every build." /><section className="section"><div className="container-wide about-split"><div><div className="eyebrow">The WETS AI point of view</div><h2 className="section-title display">Make the invisible<br />work visible.</h2></div><div><p>Good panels do not call attention to themselves. They make a machine predictable: clean wireways, readable labels, serviceable layouts, and a test record that removes doubt.</p><p>WETS AI was founded around that simple belief. We pair a practical shop floor with the documentation discipline of a larger integrator, so your team gets a partner that can move quickly without cutting corners.</p><div className="manifesto">“A panel should feel inevitable when you open the door.”</div></div></div></section><section className="section-tight dark-band"><div className="container-wide"><Stats /></div></section><section className="section"><div className="container-wide"><div className="section-header"><div><div className="eyebrow">How we got here</div><h2 className="section-title display">Built by the<br />work itself.</h2></div><p className="section-intro">Our capabilities grew alongside the machines our customers build. Every new standard came from a real field lesson.</p></div><div className="timeline"><div className="timeline-row"><span className="timeline-year">2008</span><h3>WETS AI begins</h3><p>A small, focused panel shop begins serving machine builders across the Midwest.</p></div><div className="timeline-row"><span className="timeline-year">2013</span><h3>UL 508A certification</h3><p>Our shop formalizes the documentation and inspection practice that still anchors every build.</p></div><div className="timeline-row"><span className="timeline-year">2019</span><h3>Test lab comes online</h3><p>Dedicated functional testing gives customers a clearer handoff and fewer commissioning hours.</p></div><div className="timeline-row"><span className="timeline-year">Today</span><h3>One connected standard</h3><p>OEMs, integrators, and builders use WETS AI as a reliable extension of their production floor.</p></div></div></div></section><section className="section blueprint-band"><div className="container-wide"><div className="about-split"><div><div className="eyebrow">What we protect</div><h2 className="section-title display">Your reputation<br />ships with us.</h2></div><ul className="feature-list" style={{ marginTop: 0 }}><li><ShieldCheck size={17} /> Safety and code compliance</li><li><FileCheck2 size={17} /> Revision-controlled documentation</li><li><Wrench size={17} /> Serviceable, field-ready layouts</li><li><Globe2 size={17} /> Reliable North American support</li></ul></div></div></section></main></Shell>;
}
