...
function ControlPanel() {
  ...
  const documents = ['Electrical Schematics','Wiring Diagrams','Bill of Materials (BOM)','Panel Layout Drawings','Customer Standards','Engineering Specifications'];
