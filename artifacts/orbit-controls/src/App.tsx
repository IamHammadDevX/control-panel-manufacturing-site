...
function Home() {
  return <Shell>
    ...
    <main>
      <section className="hero"><div className="container-wide hero-grid"><div className="hero-copy"><div className="eyebrow">UL 508 Custom Control Panel Manufacturing</div><h1><>Custom Control<br />Panel &amp; Industrial<br /><em>Automation</em></></h1><p className="hero-lede">Precision-built electrical control panels for OEMs, system integrators, machine builders, and industrial automation teams.</p><div className="hero-actions"><Link href="/contact" className="button-primary" data-testid="link-hero-quote">Request a Quote <ArrowRight size={15} /></Link><Link href="/control-panel" className="button-secondary" data-testid="link-hero-capabilities">Explore Capabilities <ChevronRight size={15} /></Link></div><PanelVisual /></div></section>
      <Ticker />
